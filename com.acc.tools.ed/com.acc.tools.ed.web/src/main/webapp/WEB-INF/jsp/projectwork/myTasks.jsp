						...
						<table class="innertable2" style="width: 100%;">
							...
							<c:forEach items="${release.components}" var="component">
								<tr>
									...
									<td>60</td>
									<td>
										<a href="#" taskType="myTasks" class="addTaskPopup" id="${component.componentId}"><img
											 ...
											 <c:choose>
        										<c:when test="${fn:length(component.taskFormList) gt 0}">
													<tr id="taskDatta_${tasks.taskId}" style="width: 100%;">
														...
														<td><a href="#"  taskType="myTasks" id="editTask" onclick="edit('${tasks.taskId}');"><img alt="edit project" src="./resources/edit.gif"
						width="20px;"></a>
											</td>
			...
			<div>
				<table class="addTask">
					...
					<tr id="taskActionRow" style="display:none">
								...
								<form:hidden path="taskReviewUser" id="taskReviewUser"/>
								</td>
								<td>
					...
					<tr id="taskCommentRow">
								<th style="text-align: right;">Comments</th>
								<td colspan="2">
									<div id="divComment">
									<form:textarea style="overflow: auto; resize: none" rows="3" id="taskComments" path="taskComments"
